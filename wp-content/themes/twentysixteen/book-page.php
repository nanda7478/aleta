<?php
/*
 Display Template Name: Books Page
*/
...
<div class="col-sm-6">
<img class="img-responsive" src="<?php echo site_url();?>/wp-content/uploads/2018/03/life-shift-book-cover.jpg">
</div>
<div class="col-sm-6">
<?php
 $args = array( 'post_type' => 'product', 'posts_per_page' => -1, 'product_cat' => 'books', 'order' => 'ASC' );
